...
class DataMovie {
	...
	public String toString() {
		return "DataMovie [moviename=" + moviename + ", studioname=" + studioname + ", theater=" + theater + ", rating="
...
public class Assign4 {
	...
	public static void main(String[] args) throws IOException {
		...
		List<DataMovie> movies = lines.map(str -> {
		...
		Comparator<DataMovie> cmp = new Comparator<DataMovie>() {
			public int compare(DataMovie t1, DataMovie t2) {
